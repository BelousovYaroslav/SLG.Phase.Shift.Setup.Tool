...
public class SLG_PSST_Settings {
    ...
    private boolean ReadSettings() {
        ...
        try {
            ...
            String strSettingsFilePathName = System.getenv( "SLG_ROOT") + "/etc/settings.phase.shift.setup.tool.r.xml";
        ...
        if( bResOk == true) {
            try {
                ...
                String strSettingsFilePathName = System.getenv( "SLG_ROOT") + "/etc/settings.phase.shift.setup.tool.rw.xml";
